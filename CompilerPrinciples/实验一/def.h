...
enum node_kind
{
    EXT_DEF_LIST,EXT_VAR_DEF,FUNC_DEF,FUNC_DEC,STRUCT_DEF,STRUCT_NAME,EXP_ELE,EXP_ARRAY,ARRAY_DEC,EXT_DEC_LIST,PARAM_LIST,
    PARAM_DEC,VAR_DEF,DEC_LIST,DEF_LIST,COMP_STM,STM_LIST,EXP_STMT,FOR_DEC,IF_THEN,IF_THEN_ELSE,FUNC_CALL,ARGS,FUNCTION, PARAM,ARG,
